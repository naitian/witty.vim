...
local bg_darker      = '#141414'
local bg_light       = '#333333'
local bg_lighter     = '#424242'
local grey           = '#65737E'
local grey_dark      = '#5d6a74'
local red            = '#FF5370'
local heavy_red      = '#ff294d'
local green          = '#C3E88D'
local green_high     = '#C3E88D'
local blue           = '#89DDFF'
local blue_light     = '#89DDFF'
local yellow         = '#f4f171'
local orange         = '#f4f171'
local purple         = '#988bc7'
...
local pink           = '#ff79c6'
local fg             = '#EFEFEE'
local fg_light       = '#EFEFEE'
local fg_dark        = '#EFEFEE'
local hollow         = '#424760'
